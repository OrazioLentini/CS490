...
<?php
    ...
    $grd = mysql_query("SELECT QuizName, TotalCorrect, TotalPoints, Grade, Comments FROM Grades WHERE StudentID = '1' AND Released = 'Released' ORDER BY `Grades`.`QuizName` ASC");
    ...
    curl_setopt($crl, CURLOPT_URL, "http://web.njit.edu/~ovl2/CS490/login/student/displayGrades.php");
