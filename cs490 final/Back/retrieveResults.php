<?php
    ...
    $result = mysql_query("SELECT Question, Opt1, Opt2, Opt3, Opt4, Answer, YourAnswer, CorInc, PointRec, Points, QuestionNum FROM $QuizName");
    ...
    $result = mysql_query("SELECT SUM(PointRec), SUM(Points) FROM $QuizName"); 
