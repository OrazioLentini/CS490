...
?>
    ...
    <div class="create-content">
        <form class="choice" action="http://web.njit.edu/~ovl2/CS490/login/student/retrieveResults.php" method="post">
                <table class="grades-table" border="0" cellpadding="0" cellspacing="0">
                    <?php
