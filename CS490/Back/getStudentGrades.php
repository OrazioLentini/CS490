<?php
    ...
    $crl = curl_init();
    curl_setopt($crl, CURLOPT_URL, "http://web.njit.edu/~ic35/CS490/login/teacher/getStudentGrades.php");
    //curl_setopt($crl, CURLOPT_URL, "http://web.njit.edu/~ovl2/CS490/login/teacher/getStudentGrades.php");
